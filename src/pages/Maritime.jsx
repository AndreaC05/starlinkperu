      ...
      <div className="container_maritime">
        ...
        <div className="cuerpo_planes_servicios">
          ...
          <div className="text_services_planes">
            ...
            <p>Ideal para operaciones marítimas internacionales: flotas, yates y plataformas en alta mar.</p>
            <div className="list_services">
              <h4>CARACTERÍSTICAS PRINCIPALES</h4>
              <ul>
                <li>Cobertura global en alta mar y rutas marítimas internacionales</li>
                <li>Conectividad estable en movimiento, incluso en condiciones oceánicas extremas</li>
